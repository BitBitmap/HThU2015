...
insert into classes values('DM-1114','Digital Media','Acoustics');
insert into classes values('DM-1124','Digital Media','Animation');
insert into classes values('DM-2134','Digital Media','Audio Foundation');
